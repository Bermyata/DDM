                    ...
                    if (transaction.GetObject(objectId, OpenMode.ForRead) is BlockReference brf)
                    {
                        ...
                        foreach (String name in blockNames)
                              ...
                              && CheckAsterisk(name, blockName))
                            {
                                ...
                                if (!result.ContainsKey(name)) result.Add(blockName, new List<Block>());
                        ...
                        Dictionary<String, String> visibility = new();
                        ...
                        if (attributes.Any()) result[blockNameTemplate].Add(new Block(blockName, attributes));
                    }
                }
            }
